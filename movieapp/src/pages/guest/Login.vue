<template>
    <q-layout class="bg-pink-5-grey-2" view="lHh Lpr Lff">
      <q-page-container>
                          ...
                          <div class="col-md-6">
                            <div class="row">
                                <div class="col-md-8 offset-2">
                                    <q-img src="../../statics/loginnn.jpg"></q-img>
                                </div>
                            </div>
                          </div>
                          <div class="col md-6">
                            <q-card-section>
                              ...
                              <q-form @submit="login">
                                ...
                                <q-card-section>
                                    <q-btn label="Login" type="submit" unelevated color="pink-5" class="full-width" />
